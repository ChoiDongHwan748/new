...
class Calculator:
    ...
    def circle_line_randomly_simulation(self,circle_max,line_max):
            ...
            f = open("C:\\Users\\dhcho_l0jvmvt\\Desktop\\m_angle.txt", 'a')
            ...
            f = open("C:\\Users\\dhcho_l0jvmvt\\Desktop\\m_m.txt", 'a')
            f.write(str(weighted_mean)+"\n")
            f.close()


            f= open("C:\\Users\\dhcho_l0jvmvt\\Desktop\\m_v.txt", 'a')
            f.write(str(weighted_variance)+"\n")
            f.close()

            f = open("C:\\Users\\dhcho_l0jvmvt\\Desktop\\n_m_m.txt", 'a')
            f.write(str(mean)+"\n")
            f.close()
    ...
    def circle_line_randomly_simulation_m(self):
            ...
            self.circle_line_randomly_simulation(circle_max, line_max)
    ...
    def circle_line_randomly_simulation_s(self):
           self.circle_line_randomly_simulation(1, 1)
